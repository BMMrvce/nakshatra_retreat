      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-foreground/70">
            <li><Link to="/rooms" className="hover:text-gold transition">Rooms & Suites</Link></li>
            <li><Link to="/dining" className="hover:text-gold transition">Fine Dining</Link></li>
            <li><Link to="/spa" className="hover:text-gold transition">Spa & Activities</Link></li>
            <li><Link to="/weddings" className="hover:text-gold transition">Weddings</Link></li>
